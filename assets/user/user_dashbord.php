...
<body>
        ...
        <nav class="header">
            ...
            <div class="leftheader">
                <ul>
                    ...
                    <li><a href="../php/signIn.php" target="_blank"><i class="fa-solid fa-circle-user">user</i></a></li>
                </ul>
                <div class="burger">
                    <div class="line"></div>
                    <div class="line"></div>
    ...
    <div class="webcontainer">
        ...
        <div class="containerdata">
            ...
            <button class="btn1"> <a href="../webdevelopment/home.php" target="_blank">START BUILDING</a></button>
    ...
    <section class="memberpanal">
        ...
        <div class="box">
            <div class="subbox">
                <div class="image">
                    <img src="../img/video-bg.jpg" alt="" srcset="">
